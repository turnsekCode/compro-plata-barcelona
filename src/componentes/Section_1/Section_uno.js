  ...
  return (
    <section className={styles.contenedorSectionUno}>
      <div className={styles.bloqueIzq}>
        <h1>
          Compro Plata <span className={styles.linea}>Barcelona</span>
        </h1>
        <p>
          Vender plata en Barcelona nunca había sido tan fácil. En Quickgold te
      ...
      <div className={styles.bloqueDer}>
        {width <= 610 ? (
          <img
            ...
            className={styles.barcelonaMobil}
            width={290}
            height={220}
          />
        ) : (
