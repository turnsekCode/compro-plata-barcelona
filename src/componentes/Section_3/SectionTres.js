    ...
    <section className={styles.contenedorSectionTres}>
      <div className={styles.contenedorContenidoUno}>
        <div className={styles.bloqueIzq}>
          ...
          <p>
            <span>
              Ven a nuestra tienda compro plata en Barcelona y trae tus piezas
              de plata que ya no quieres, o no utilizas. Nuestro equipo tasará
              tus joyas delante de ti, y te indicará el precio de la plata en
        ...
        <div className={styles.bloqueDer}>
          <h2>¿Cuál es el precio de la plata en Barcelona?</h2>
          <p>
